...
val picardsShip2 = "Picard" -> ("Enterprise-D", "NCC-1701-D")
...
println(shipList(1))
println(shipList(0)) // zero-based
println(shipList(3))

println(shipList.head) // item
println(shipList.tail) // List
...
//////////////////////////
// MAPS
// data type needs to be the same for each key-value pair
//////////////////////////
...
val li20 = 1 to 20
li20.foreach(println)

for (x <- li20) {
  if (x % 3 == 0) println(x)
}

val li20_3 = li20.filter(x => x % 3 == 0)
println(li20_3)